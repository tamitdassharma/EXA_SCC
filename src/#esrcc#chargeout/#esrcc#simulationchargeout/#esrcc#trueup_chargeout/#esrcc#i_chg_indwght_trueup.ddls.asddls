...
define view entity /ESRCC/I_CHG_INDWGHT_TRUEUP
  as select from /ESRCC/I_CHG_RECEIVERS_TRUEUP as chargeoutreceivers
 
  association [0..*] to /ESRCC/I_SRVCHGWGHT_TRUEUP as weightage 
