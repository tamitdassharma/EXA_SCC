...
CLASS LHC_/ESRCC/I_HIER2_S IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE /ESRCC/I_Hier2\_HierarchyText,
          text_for_existing_entity TYPE TABLE FOR CREATE /ESRCC/I_Hier2\_HierarchyText,
          text_update              TYPE TABLE FOR UPDATE /ESRCC/I_Hier2Text.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK /ESRCC/I_Hier2\_HierarchyText,
    ...
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF /ESRCC/I_Hier2_S
      ENTITY Hierarchy
    ...
    IF entities_update IS NOT INITIAL.
      READ ENTITIES OF /ESRCC/I_Hier2_S
