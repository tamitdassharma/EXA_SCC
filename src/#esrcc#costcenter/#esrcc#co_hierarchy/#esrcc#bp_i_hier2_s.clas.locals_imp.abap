CLASS lcl_custom_validation DEFINITION.
  PUBLIC SECTION.
    TYPES:
      ts_hierarchy        TYPE STRUCTURE FOR READ RESULT /esrcc/i_hier2_s\\hierarchy,
      tt_hierarchy_create TYPE TABLE FOR CREATE /esrcc/i_hier2_s\\hierarchyall\_hierarchy,
      BEGIN OF ts_control,
  ...
  METHOD precheck_cba_hierarchy.
    DATA(lo_validation) = NEW lcl_custom_validation( config_util_ref = /esrcc/cl_config_util=>create(
      EXPORTING
        ...
        source_entity_name = '/ESRCC/C_HIER2'
...
CLASS lhc_rap_tdat_cts IMPLEMENTATION.
  METHOD get.
    result = mbc_cp_api=>rap_tdat_cts( tdat_name = '/ESRCC/HIER2'
                                       table_entity_relations = VALUE #(
                                         ( entity = 'Hierarchy' table = '/ESRCC/HIER2' )
                                         ( entity = 'HierarchyText' table = '/ESRCC/HIER2_T' )
                                       ) ) ##NO_TEXT.
  ENDMETHOD.
ENDCLASS.
CLASS lhc_/esrcc/i_hier2_s DEFINITION FINAL INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    METHODS:
...
CLASS lhc_/esrcc/i_hier2_s IMPLEMENTATION.
  METHOD get_instance_features.
    ...
    ENDIF.
    READ ENTITIES OF /esrcc/i_hier2_s IN LOCAL MODE
    ENTITY hierarchyall
  ...
  METHOD selectcustomizingtransptreq.
    MODIFY ENTITIES OF /esrcc/i_hier2_s IN LOCAL MODE
      ENTITY hierarchyall
  ...
  METHOD get_global_authorizations.
    AUTHORITY-CHECK OBJECT 'S_TABU_NAM' ID 'TABLE' FIELD '/ESRCC/I_HIER2' ID 'ACTVT' FIELD '02'.
...
ENDCLASS.
CLASS lsc_/esrcc/i_hier2_s DEFINITION FINAL INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
    METHODS:
...
CLASS lsc_/esrcc/i_hier2_s IMPLEMENTATION.
  ...
  ENDMETHOD.
ENDCLASS.
CLASS lhc_/esrcc/i_hier2 DEFINITION FINAL INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    METHODS:
...
CLASS lhc_/esrcc/i_hier2 IMPLEMENTATION.
  METHOD validatetransportrequest.
    DATA change TYPE REQUEST FOR CHANGE /esrcc/i_hier2_s.
    SELECT SINGLE transportrequestid
      FROM /esrcc/d_hier2_s
      WHERE singletonid = 1
  ...
  ENDMETHOD.
  METHOD copy.
    DATA new_hierarchy TYPE TABLE FOR CREATE /esrcc/i_hier2_s\_hierarchy.
    DATA new_hierarchytext TYPE TABLE FOR CREATE /esrcc/i_hier2_s\\hierarchy\_hierarchytext.
  ...
  ENDMETHOD.
ENDCLASS.
CLASS lhc_/esrcc/i_hier2text DEFINITION FINAL INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    METHODS:
      validatetransportrequest FOR VALIDATE ON SAVE
        IMPORTING
...
CLASS lhc_/esrcc/i_hier2text IMPLEMENTATION.
  METHOD validatetransportrequest.
    DATA change TYPE REQUEST FOR CHANGE /esrcc/i_hier2_s.
    SELECT SINGLE transportrequestid
      FROM /esrcc/d_hier2_s
