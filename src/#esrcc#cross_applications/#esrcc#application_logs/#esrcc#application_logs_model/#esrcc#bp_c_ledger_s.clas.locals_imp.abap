CLASS LHC_/ESRCC/I_LEDGER_S DEFINITION FINAL INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      AUGMENT FOR MODIFY
        IMPORTING
          ENTITIES_CREATE FOR CREATE LedgerAll\_Ledger
          ENTITIES_UPDATE FOR UPDATE Ledger.
ENDCLASS.

CLASS LHC_/ESRCC/I_LEDGER_S IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE /ESRCC/I_Ledger\_LedgerText,
          text_for_existing_entity TYPE TABLE FOR CREATE /ESRCC/I_Ledger\_LedgerText,
          text_update              TYPE TABLE FOR UPDATE /ESRCC/I_LedgerText.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK /ESRCC/I_Ledger\_LedgerText,
