CLASS LHC_/ESRCC/I_REGION_S DEFINITION FINAL INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      AUGMENT FOR MODIFY
        IMPORTING
          ENTITIES_CREATE FOR CREATE RegionAll\_Regions
          ENTITIES_UPDATE FOR UPDATE Regions.
ENDCLASS.

CLASS LHC_/ESRCC/I_REGION_S IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE /ESRCC/I_Regions\_RegionText,
          text_for_existing_entity TYPE TABLE FOR CREATE /ESRCC/I_Regions\_RegionText,
          text_update              TYPE TABLE FOR UPDATE /ESRCC/I_RegionText.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK /ESRCC/I_Regions\_RegionText,
