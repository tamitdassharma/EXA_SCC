...
CLASS LHC_/ESRCC/I_ROYCOMP_S IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE /ESRCC/I_RoyComp\_RuleText,
          text_for_existing_entity TYPE TABLE FOR CREATE /ESRCC/I_RoyComp\_RuleText,
          text_update              TYPE TABLE FOR UPDATE /ESRCC/I_RoyCompText.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK /ESRCC/I_RoyComp\_RuleText,
    ...
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF /ESRCC/I_RoyComp_S
      ENTITY Rule
        CREATE BY \_RuleText
    ...
    IF entities_update IS NOT INITIAL.
      READ ENTITIES OF /ESRCC/I_RoyComp_S
